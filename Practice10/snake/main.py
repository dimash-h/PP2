...
def main():
    ...
    while True:
        ...
        if snake_pos[0] == food_pos[0] and snake_pos[1] == food_pos[1]:
            score += 1
            # Increase level every 4 foods collected
            if score % 4 == 0:
                level += 1
                speed += 2 # Increase speed dynamically
            food_spawn = False
        else:
        ...
        # Draw Food
        pygame.draw.rect(DISPLAYSURF, RED, pygame.Rect(food_pos[0], food_pos[1], BLOCK_SIZE, BLOCK_SIZE))
